    ...
    ll ans=0;
         for(int i=0;i<k;i++){
             if(n%2==0){
                 ...
                 ll all1=(p1+p2+p4)%mod;
                 if(i==0){
                     all1=1;
                     //p1=1;
                     p4=1;
                 }
                 ll equal1=s%mod*p4%mod;
                 all1+=s%mod*p1%mod;
                 all1%=mod;
                 ll p3=power(2,i+1);
                 //cout<<p3<<sp;
                 ...
                 ll small=(p3-(all1+equal1)+mod)%mod;
                 greater[i]=(all1)%mod;
                 smaller[i]=small%mod;
                 equal[i]=equal1;
                 //cout<<greater[i]<<sp<<smaller[i]<<endl;
                 ans=(greater[i]+equal[i])%mod;
